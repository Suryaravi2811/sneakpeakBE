...
//		ProductDTO expectedProductDTO = new ProductDTO(1L, "Test Product",, "Type", "100", "Fast", "Description", "Details", "Waterproof", "Style", "Closure", "Heel", "Country", "Color", "Brand", "Manufacturer Details");
